...
output_uri = 'gs://testing-embedding-file/image_batch_prediction_fldr_out'

# TODO(developer): Update and un-comment below line
# PROJECT_ID = "your-project-id"

# Initialize vertexai
vertexai.init(project='nine-demo' , location="us-central1")

input_uri = "gs://cloud-samples-data/batch/prompt_for_batch_gemini_predict.jsonl"
input_uri="gs://testing-embedding-file/new 5.json"
...
# Set parameters
GOOGLE_CLOUD_PROJECT = 'nine-demo'
GOOGLE_CLOUD_REGION = 'us-central1'
model_id = 'gemini-1.5-pro-002'  # Your model ID
output_uri = 'gs://testing-embedding-file/image_batch_prediction_fldr_out'
input_uri ='gs://testing-embedding-file/test_image.json'# 'gs://testing-embedding-file/req.json'
