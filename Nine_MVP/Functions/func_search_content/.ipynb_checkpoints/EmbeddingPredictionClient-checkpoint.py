...
class EmbeddingPredictionClient:
    ...
    def __init__(
        ...
        text_model: str ="textembedding-gecko",
        multimodal_model: str="/publishers/google/models/multimodalembedding@001"
        ...
        self.text_embedding_model = TextEmbeddingModel.from_pretrained(text_model)
        self.multimodal_embedding_model=multimodal_model
    ...
    def get_multimodal_embedding(self, text: str = None, image_file: str = None):
        ...
        instances = [instance]
        endpoint = (
           f"projects/{self.project}/locations/{self.location}{self.multimodal_embedding_model}"
        )
